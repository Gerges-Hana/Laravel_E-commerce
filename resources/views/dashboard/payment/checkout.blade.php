                ...
                <div class="card">
                    ...
                    <tbody>
                        <tr>
                            <td data-th="Product">
                                <div class="row">
                                    <div class="col-sm-3 hidden-xs"><img src="{{ asset('dashboard/assets/images/11.jpg') }}" width="100" height="100" class="img-responsive"/></div>
                                    <div class="col-sm-9">
                                        <h4 class="nomargin">تيشرت قطني باكمام سادة وطباعة كتابة للرجال</h4>
                                    </div>
                                </div>
                            </td>
                            <td data-th="Price">$33</td>
                            <td data-th="Quantity">
                    ...
                    <tfoot>
                        ...
                        <tr>
                            <td colspan="5" style="text-align:right;">
                                ...
                                <input type='hidden' name="productname" value="Asus Vivobook 17 Laptop - Intel Core 10th ggggggg">
